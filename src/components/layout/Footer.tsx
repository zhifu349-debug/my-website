...
export default function Footer() {
  ...
  const navItems = [
    { href: '/vps', labelKey: 'navigation.vps' },
    { href: '/ai-tools', labelKey: 'navigation.aiTools' },
    { href: '/tutorials', labelKey: 'navigation.tutorials' },
    { href: '/comparisons', labelKey: 'navigation.comparisons' },
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 lg:gap-12">
          <div className="col-span-1 md:col-span-2">
            <h3 className="text-xl font-bold gradient-text mb-4">{t('footer.about')}</h3>
          ...
          <div>
            <h3 className="text-lg font-bold text-gray-900 mb-4">{t('footer.categories')}</h3>
          ...
          <div>
            <h3 className="text-lg font-bold text-gray-900 mb-4">{t('footer.legal')}</h3>
            <ul className="space-y-3">
              {legalItems.map((item) => (
                <li key={item.href}>
                  <Link
