...
export default function RecommendationTemplate({ data, locale = 'en' }: RecommendationTemplateProps) {
  const comparisonHeaders = ['Solution', 'Price', 'Rating', 'Best For', 'Action']
  ...
  return (
    <article className="max-w-5xl mx-auto px-4 py-8">
              ...
              <div className="flex items-center justify-between mb-6">
                ...
                {solution.rating && (
                  <div className="flex items-center gap-1 bg-yellow-50 px-3 py-1 rounded-full">
                    ...
                    <span className="font-bold text-gray-900">{solution.rating}/5</span>
                  </div>
                )}
              </div>
      ...
      <section className="mb-12 bg-gradient-to-r from-blue-600 to-purple-600 rounded-2xl p-8 text-white">
        <h2 className="text-2xl md:text-3xl font-bold mb-6">Which One Should You Choose?</h2>
