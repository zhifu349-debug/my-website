...
export async function generateMetadata({
  ...
  return {
    title:
      locale === "zh" ? "资源 - 深度指南和资源" : "Resources - In-depth Guides",
    description:
      locale === "zh"
        ? "高质量的学习资源和工具，提升你的技能"
        : "High-quality learning resources and tools to boost your skills",
  ...
  const resources = [
    {
      ...
      description:
        locale === "zh"
          ? "从选择到部署，全方位掌握VPS主机知识"
          : "Master VPS hosting knowledge from selection to deployment",
    ...
    },
    {
      ...
      description:
        locale === "zh"
          ? "从入门到专家的完整Docker学习路径"
          : "Complete Docker learning path from beginner to expert",
    ...
    },
    {
      ...
      title:
        locale === "zh"
          ? "React 设计模式手册"
          : "React Design Patterns Handbook",
      description:
        locale === "zh"
          ? "20+种React设计模式，提升代码质量"
          : "20+ React design patterns to improve code quality",
    ...
    },
    {
      ...
      description:
        locale === "zh"
          ? "保护你的API免受各种安全威胁"
          : "Protect your API from various security threats",
    ...
    },
    {
      ...
      description:
        locale === "zh"
          ? "提升网站速度和用户体验的50+技巧"
          : "50+ tips to improve website speed and user experience",
    ...
    },
    {
      ...
      description:
        locale === "zh"
          ? "掌握AWS、Google Cloud、Azure等云平台部署"
          : "Master deployment on AWS, Google Cloud, Azure, and more",
      ...
      <div className="bg-gradient-to-r from-pink-600 via-purple-600 to-blue-600 py-16">
        <div className="max-w-4xl mx-auto px-4 text-center text-white">
          ...
          <p className="text-xl text-white/90 max-w-2xl mx-auto">
            {locale === "zh"
              ? "高质量的指南、课程和工具，加速你的成长"
              : "High-quality guides, courses, and tools to accelerate your growth"}
          </p>
        </div>
      </div>
      ...
      <section className="max-w-6xl mx-auto px-4 py-16">
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          {resources.map((resource) => (
            ...
            >
              <div
                className={`bg-gradient-to-br ${resource.gradient} p-6 text-white`}
              >
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <p className="text-white/90 text-sm">
                {locale === "zh"
                  ? "所有内容都来自实战经验"
                  : "All content from real-world experience"}
              </p>
            </div>
            <div className="text-center">
              <div className="w-16 h-16 bg-white/20 rounded-2xl flex items-center justify-center mx-auto mb-4 text-3xl">
