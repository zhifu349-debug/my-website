...
export async function generateMetadata({ params }: PrivacyPageProps): Promise<Metadata> {
  ...
  return {
    ...
    description: locale === 'zh' ? '了解我们如何收集、使用和保护您的个人信息' : 'Learn how we collect, use, and protect your personal information',
    alternates: {
  ...
  const content = {
    en: {
      ...
      sections: [
        ...
        {
          title: 'Your Rights',
          content: 'You have the right to access, correct, or delete your personal information. You may also opt out of receiving marketing communications from us.'
        },
        {
          title: 'Contact Us',
    ...
    zh: {
      ...
      sections: [
        {
          title: '我们收集的信息',
          content: '我们收集您直接提供给我们的信息，例如当您创建账户、订阅我们的新闻通讯或联系我们要寻求支持时。'
        },
        {
          title: '我们如何使用您的信息',
          content: '我们使用收集到的信息来提供、维护和改进我们的服务，与您沟通，并遵守法律义务。'
        },
        {
          title: '信息共享',
          content: '我们不会出售您的个人信息。我们可能与协助我们运营服务的服务提供商共享您的信息。'
        },
        {
          title: '数据安全',
          content: '我们采取适当的安全措施来保护您的个人信息免受未经授权的访问、更改、披露或破坏。'
        },
        {
          title: '您的权利',
          content: '您有权访问、更正或删除您的个人信息。您也可以选择不接收我们的营销通讯。'
        },
        {
          title: '联系我们',
          content: '如果您对本隐私政策有任何疑问，请通过 privacy@example.com 联系我们'
        }
      ]
    }
  }
