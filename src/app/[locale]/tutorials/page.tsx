...
export async function generateMetadata({
  ...
  return {
    ...
    description:
      locale === "zh"
        ? "详细的技术教程，帮助您掌握各种技能"
        : "Detailed technical tutorials to help you master various skills",
  ...
  const tutorials = [
    {
      id: "v2ray-setup",
      title:
        locale === "zh" ? "V2Ray 完整配置教程" : "Complete V2Ray Setup Guide",
      description:
        locale === "zh"
          ? "从零开始配置V2Ray代理，包括服务器搭建和客户端设置"
          : "Set up V2Ray proxy from scratch, including server setup and client configuration",
    ...
    },
    {
      ...
      title:
        locale === "zh" ? "Docker 容器部署实战" : "Docker Container Deployment",
      description:
        locale === "zh"
          ? "学习使用Docker部署Web应用，掌握容器化技术"
          : "Learn to deploy web apps with Docker and master containerization",
    ...
    },
    {
      ...
      description:
        locale === "zh"
          ? "提升React应用性能的20个实用技巧和最佳实践"
          : "20 practical tips and best practices to improve React app performance",
    ...
    },
    {
      id: "nginx-config",
      title:
        locale === "zh" ? "Nginx 高级配置教程" : "Advanced Nginx Configuration",
      description:
        locale === "zh"
          ? "配置反向代理、负载均衡、SSL证书等高级功能"
          : "Configure reverse proxy, load balancing, SSL certificates and more",
    ...
    },
    {
      ...
      description:
        locale === "zh"
          ? "从零开始学习Next.js静态网站生成，提升SEO性能"
          : "Learn Next.js static site generation from scratch to improve SEO",
    ...
    },
    {
      id: "api-security",
      title:
        locale === "zh" ? "API 安全最佳实践" : "API Security Best Practices",
      description:
        locale === "zh"
          ? "保护你的API免受常见攻击，确保数据安全"
          : "Protect your API from common attacks and ensure data security",
      ...
      <div className="bg-gradient-to-r from-green-600 via-blue-600 to-purple-600 py-16">
        <div className="max-w-4xl mx-auto px-4 text-center text-white">
          ...
          <p className="text-xl text-white/90 max-w-2xl mx-auto">
            {locale === "zh"
              ? "从零到精通，掌握最新的技术栈和实践"
              : "From beginner to expert, master the latest tech stack and practices"}
          </p>
        </div>
      </div>
      ...
      <section className="max-w-6xl mx-auto px-4 py-16">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          {tutorials.map((tutorial) => (
            ...
            >
              <div
                className={`absolute inset-0 bg-gradient-to-br ${tutorial.gradient} opacity-0 group-hover:opacity-5 transition-opacity duration-300 rounded-2xl`}
              ></div>
              <div className="relative">
                <div
                  className={`w-16 h-16 rounded-2xl bg-gradient-to-br ${tutorial.gradient} flex items-center justify-center text-3xl mb-4 shadow-lg group-hover:scale-110 transition-transform duration-300`}
                >
                  {tutorial.icon}
                </div>
                <div className="flex items-start justify-between mb-3">
                  <span
                    className={`px-3 py-1 rounded-full text-xs font-medium ${difficultyColors[tutorial.difficulty as keyof typeof difficultyColors]}`}
                  >
                    {tutorial.difficulty}
                  </span>
          ...
          <div className="flex flex-col md:flex-row items-center gap-8">
            <div className="flex-1">
              ...
              <h2 className="text-3xl md:text-4xl font-bold mb-4">
                {locale === "zh"
                  ? "Next.js SSG 完全指南"
                  : "Complete Next.js SSG Guide"}
              </h2>
              <p className="text-white/90 mb-6 leading-relaxed">
                {locale === "zh"
                  ? "学习如何使用Next.js构建高性能SEO友好的静态网站，提升你的项目排名"
                  : "Learn how to build high-performance SEO-friendly static websites with Next.js to boost your rankings"}
              </p>
              <Link
