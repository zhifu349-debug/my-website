...
export const metadata = {
  ...
  description: 'In-depth reviews, comparisons, and tutorials to help you make informed decisions',
  keywords: 'VPS, AI Tools, Reviews, Comparisons, Tutorials',
}

export default function Home() {
  const categories = [
    { href: '/vps', title: 'VPS Hosting', description: 'Find best VPS providers for your projects', icon: '🖥️', gradient: 'from-blue-500 to-blue-600' },
    { href: '/ai-tools', title: 'AI Tools', description: 'Discover powerful AI tools and services', icon: '🤖', gradient: 'from-purple-500 to-purple-600' },
    { href: '/tutorials', title: 'Tutorials', description: 'Step-by-step guides for developers', icon: '📚', gradient: 'from-green-500 to-green-600' },
    { href: '/comparisons', title: 'Comparisons', description: 'Compare products side by side', icon: '⚖️', gradient: 'from-orange-500 to-orange-600' },
    { href: '/resources', title: 'Resources', description: 'In-depth guides and resources', icon: '📦', gradient: 'from-pink-500 to-pink-600' },
  ]
          ...
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <p className="text-gray-700 leading-relaxed">
                We may earn a commission when you purchase through our links. This helps us continue providing free content and reviews. We only recommend products we trust.
              </p>
            </div>
          </div>
        </div>
