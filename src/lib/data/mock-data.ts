...
export const mockRecommendationPage: RecommendationPage = {
  ...
  selectionGuide: {
    beginners: 'Choose DigitalOcean for excellent documentation and community support',
    advanced: 'Linode offers more control and better performance for technical users',
    specialNeeds: 'Vultr provides global data centers for worldwide audiences'
  },
  faqs: [
    {
      question: 'What is a VPS?',
      answer: 'A Virtual Private Server (VPS) is a virtual machine sold as a service by an Internet hosting service.'
    },
    {
      question: 'How much does a VPS cost?',
      answer: 'VPS hosting typically costs between $4-20 per month for basic plans.'
    },
    {
      question: 'Do I need technical skills?',
      answer: 'Basic Linux knowledge is helpful, but many providers offer managed services.'
    }
  ],
...
export const mockReviewPage: ReviewPage = {
  ...
  background: 'Vultr is a cloud computing platform founded in 2014. It provides scalable cloud servers for developers and businesses.',
  features: [
  ...
  performance: 'Excellent performance with NVMe SSD storage and 99.9% uptime SLA.',
  pricing: 'Hourly billing starting at $5/month with no long-term contracts.',
  testResults: [
    { metric: 'Boot Time', value: '45 seconds', details: 'Fast boot times across all plans' },
    { metric: 'I/O Performance', value: '500 MB/s', details: 'Consistent NVMe SSD speeds' },
    { metric: 'Uptime', value: '99.9%', details: 'Based on 6-month testing' }
  ],
  screenshots: [],
  conclusion: 'Vultr is an excellent choice for developers and small businesses looking for affordable, reliable cloud hosting.',
  suitableFor: [
  ...
  faqs: [
    {
      ...
      answer: 'Yes, Vultr provides good documentation and a user-friendly interface for beginners.'
    },
    {
      question: 'Does Vultr offer free trial?',
      answer: 'Vultr offers a limited credit for new users to test their services.'
    }
  ],
  ...
  scenarioComparison: [
    {
      ...
      reason: 'DigitalOcean has excellent documentation and a more user-friendly interface'
    },
    {
  ...
  faqs: [
    {
      ...
      answer: 'DigitalOcean starts at $4/month, while Vultr starts at $5/month.'
    },
    {
...
export const mockTutorialPage: TutorialPage = {
  ...
  background: 'V2Ray is a proxy tool that helps you bypass internet restrictions. This guide will walk you through the setup process.',
  prerequisites: [
  ...
  steps: [
    {
      ...
      content: 'Select a VPS provider based on your needs. We recommend starting with DigitalOcean or Vultr for beginners.'
    },
    {
      id: 'step2',
      title: 'Create a Server Instance',
      content: 'Create a new droplet/server with at least 1GB RAM. Choose Ubuntu 20.04 or 22.04 as the OS.'
    },
    {
      id: 'step3',
    ...
    },
    {
      id: 'step4',
      title: 'Install V2Ray',
      content: 'Run the installation script: bash <(curl -L https://raw.githubusercontent.com/v2fly/fhs-install-v2ray/master/install-release.sh)'
    }
  ],
  commonErrors: [
    { error: 'Connection timeout', solution: 'Check your firewall settings and ensure port 443 is open.' },
    { error: 'Permission denied', solution: 'Make sure you are using sudo or logging in as root.' }
  ],
  recommendedProducts: mockSolutions.slice(0, 2),
  faqs: [
    {
      question: 'Is V2Ray legal?',
      answer: 'V2Ray is a legitimate tool for network proxying. Always comply with local laws and regulations.'
    },
    {
      question: 'How do I update V2Ray?',
      answer: 'Run the update script provided by the official V2Ray repository.'
    }
  ],
...
export const mockResourcePage: ResourcePage = {
  ...
  valueProposition: 'Learn how to choose, set up, and manage your VPS server effectively',
  targetAudience: [
  ...
  contents: [
    {
      ...
      content: 'A comprehensive overview of what VPS hosting is and why you might need it.'
    },
    {
      id: 'section2',
      title: 'Choosing a Provider',
      content: 'Detailed comparison of top VPS providers and how to select the right one.'
    },
    {
      id: 'section3',
  ...
  pricing: [
    {
      plan: 'Basic',
      price: 'Free',
      features: ['Essential VPS knowledge', 'Basic setup guide', 'Provider comparison']
    },
    {
      plan: 'Pro',
      price: '$29',
      features: ['Advanced configurations', 'Security best practices', 'Optimization tips', 'Case studies']
    }
  ],
  faqs: [
    {
